...
// import {ReactComponent as SolidLogo} from "../../assets/pictures/Icons/solidworks.svg";

export const SkillsData = [
    {
        name: 'Solidworks',
        description: '3D modelling, Drawing, Drafting, Simulation, Motion Study',
        id: 0,
    },
    {
        name: 'Matlab',
        description: 'Programming, Simulink, Machine learning (ANN Toolbox)',
        id: 0,
    },
    {
        name: 'Ansys',
        description: 'Turbomachinery, Fluent, Mechanical',
        id: 0,
    },
    {
        name: 'Python',
        description: 'Programming, Numpy, Pandas, Machine learning (Scikit learn, TensorFlow )',
        id: 0,
    },
    {
        name: 'PVsyst',
    ...
    {
        name: 'Homer',
        description: 'Renewable Energy system simulation',
        id: 0,
    },
    {
        name: 'Autocad',
        description: 'Drafting, Construction Drawing, Cutting plan',
        id: 0,
    },
    {
        name: 'AVEVA PDMS',
        description: 'Piping, Iso draft',
        id: 0,
    },
    {
        name: 'EES',
    ...
    },
    {
        ...
        description: 'Word, Excel, Project, Power point',
        id: 0,
    },
    {
        name: 'Sidewinder',
        description: 'Conveyor designing',
        id: 0,
    },
]